...
Optimal: $\lambda=0.427$ with  out-of-sample misclassification of 9.6\%.
Now check most important predictors and in-sample diagnostics for the optimal lambda:
...
- Optimized parameter: Optimal lambda package vs own (show with plot)
- Prediction success: measures of classification own and package linear (density plot of predictions, hitrate, misclassiffciation rate, precision)
- Predictor importance: identified Weights and their interpretation (show with table)
